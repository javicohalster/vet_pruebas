    ...
    public function show()
    {
        ...
        return  datatables()
                ...
                return '<a href="#" onclick="roles_user('.$user->id.')" class="btn btn-simple btn-warning btn-icon edit" data-toggle="modal" data-target="#roleModal"><i class="material-icons">settings_brightness</i></a>
                        <a href="#" onclick="carga_usuario('.$user->id.')" data-toggle="modal" data-target="#modal_editar_recepcionista" rel="tooltip" title="Editar" class="btn btn-simple btn-success btn-icon edit"><i class="material-icons">edit</i></a>
