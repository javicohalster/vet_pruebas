                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input id="hora_inicio" name="hora_inicio" type="text" class="form-control timepicker" placeholder="00:00" value="00:00"/>                    
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label">HORA FIN</label>
                                    <input id="hora_fin" name="hora_fin" type="text" class="form-control timepicker" placeholder="00:15" value="00:15" />       
                                </div>
                            </div>
                        </div>
                        @role('doctor')
                                  ...
                                  <select id="paciente_id" name="paciente_id" class="selectpicker show-tick" data-dropup-auto="false" data-size="5" data-live-search="true" data-live-search="true" data-style="select-with-transition">
                                        <option value="">-- Seleccione --</option>
                                         @foreach($pacientes as $paciente)
                                            <option value="{{ $paciente->id }}">{{ $paciente->id }}  {{ $paciente->nombres }} - {{ $paciente->apellidos }}</option>
                                        @endforeach
                                  </select>
                                </div>
                            </div>
